...
namespace Vivero.Migrations
{
    ...
    [Migration("20210108032244_PlantaActiva2")]
    partial class PlantaActiva2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Vivero.Models.Contacto", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("ID")
            ...
            modelBuilder.Entity("Vivero.Models.Planta", b =>
                {
                    ...
                    b.Property<string>("TemperaturaIdeal")
                        .HasColumnName("Temperatura Ideal")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Vivero.Models.Planta", b =>
                {
                    b.HasOne("Vivero.Models.TipoPlanta", null)
                        .WithMany("Plantas")
